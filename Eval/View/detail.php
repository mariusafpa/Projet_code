    ...
    <img src="<?php echo $row->getImg()?>">
        ...
        <form class="row g-3" action="" method="post">
            ...
            <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="validationDefault02" name="cat"
            ...
            <div class="col-md-12">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                    readonly><?php echo $row->pro_description?></textarea>
            </div>
            <div class="col-md-12">
                <label for="validationDefault05" class="form-label">Prix :</label>
                <input type="text" class="form-control" id="validationDefault05" name="prix"
            ...
            <div class="col-md-12">
                ...
                <div class="text-center">
                    <a href="../Controlers/formulaire_jarditou.php?pro_id=<?php echo $row->pro_id ?>"><button
                            type="button" class="btn btn-warning">Modifier</button></a>
                    <a href="delete.php?pro_id=<?php echo $row->pro_id?>"><button type="button"
                            class="btn btn-danger">Supprimer</button></a>
                    <a href="list.php"><button type="button" class="btn btn-secondary">Retour</button></a>
                </div>
                <br>
        </form>
        <br>
